# C12 - Méthode de recherche autodidacte assistée par IA pour structuration, critique et falsification

## Titre scientifique prudent
Méthode de recherche autodidacte assistée par IA pour structuration, critique et falsification comme contribution candidate exploratoire.

## Résumé
Cette fiche décrit **Recherche autodidacte IA** comme une contribution candidate issue du projet **Méthode Nora / IA**. Le problème traité est: Transformer intuitions autodidactes en objets de travail critiquables. L'idée centrale est: Boucle INPUT -> STRUCTURATION -> FORMALISATION -> PROTOTYPAGE -> CONTROLE -> FALSIFICATION -> DOCUMENTATION -> RELECTURE HUMAINE. Le statut de maturité est **D - modèle formalisé documentaire**. Aucune nouveauté scientifique n'est revendiquée: **combinaison originale de concepts connus; originalité non déterminée**. La prochaine étape consiste à: Comparer aux pratiques d'IA en recherche, notebooks et open science.

## Problème
Transformer intuitions autodidactes en objets de travail critiquables.
...
## Définitions
- Source: Méthode Nora / IA.
- Famille: méthode de recherche autodidacte assistée par IA.
- Statut de preuve: D - modèle formalisé documentaire.
- Statut de nouveauté: combinaison originale de concepts connus; originalité non déterminée.
...
## Équations
Aucune équation n'est incluse dans cette fiche, car aucune équation interprétable et justifiée n'est actuellement disponible dans le dossier public pour C12.

## Algorithme ou pseudo-code
```text
Entrée: corpus, sources ou hypothèse C12
...
Comparaison à vérifier dans la famille: méthode de recherche autodidacte assistée par IA. Aucune source bibliographique n'est inventée dans cette fiche.

## Niveau de maturité
D - modèle formalisé documentaire

## Prochaines expériences numériques
Comparer aux pratiques d'IA en recherche, notebooks et open science.
