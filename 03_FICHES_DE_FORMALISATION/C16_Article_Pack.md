# C16 - Découpage en articles publiables plutôt qu'un récit unique trop vaste

## Titre scientifique prudent
Découpage en articles publiables plutôt qu'un récit unique trop vaste comme contribution candidate exploratoire.

## Résumé
Cette fiche décrit **Article Pack** comme une contribution candidate issue du projet **Publication**. Le problème traité est: Éviter un article gigantesque mêlant informatique, physique et spéculation. L'idée centrale est: Séparer architecture, TimeWarp, taxonomie, Niffoi, distorsion froide et méthode IA. Le statut de maturité est **D - plan formalisé**. Aucune nouveauté scientifique n'est revendiquée: **non applicable; stratégie**. La prochaine étape consiste à: Prioriser article FractalOS/AIONE.

## Problème
Éviter un article gigantesque mêlant informatique, physique et spéculation.
...
## Définitions
- Source: Publication.
- Famille: publications proposées.
- Statut de preuve: D - plan formalisé.
- Statut de nouveauté: non applicable; stratégie.
...
## Équations
Aucune équation n'est incluse dans cette fiche, car aucune équation interprétable et justifiée n'est actuellement disponible dans le dossier public pour C16.

## Algorithme ou pseudo-code
```text
Entrée: corpus, sources ou hypothèse C16
...
Comparaison à vérifier dans la famille: publications proposées. Aucune source bibliographique n'est inventée dans cette fiche.

## Niveau de maturité
D - plan formalisé

## Prochaines expériences numériques
Prioriser article FractalOS/AIONE.
